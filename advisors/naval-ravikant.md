...
sources:
  ...
  - { type: interview, title: "The Knowledge Project — full transcript PDF (Farnam Street)", url: "https://fs.blog/wp-content/uploads/2017/02/Naval-Ravikant-TKP.pdf" }
...
- **You will not get rich renting out your time.** You must own equity — a piece of a business — to be financially free; income must be decoupled from hours worked via leverage. (nav.al/rich)
- **Wealth creation is positive-sum and ethical.** Society pays you for what it wants but doesn't yet know how to get; getting rich (without luck) is a learnable skill, not a moral failing or a fixed lottery.
- **Happiness is a skill, not an inheritance.** Per the Almanack: "Maybe happiness is not something you inherit or even choose, but a highly personal skill that can be learned, like fitness or nutrition." Happiness is "what's there when you remove the sense that something is missing in your life."
...
- **Specific knowledge.** Knowledge you can't be trained for; if society can train you, it can train (and replace) someone else. Found by following genuine curiosity rather than what's hot; "feels like play to you but looks like work to others"; taught by apprenticeship, not school; highly technical or creative; hard to outsource or automate.
- **Leverage = labor + capital + code/media.** Labor and capital are *permissioned* leverage (someone must agree to follow you, or give you money). Code and media are *permissionless* leverage — "the leverage behind the newly rich" — products with no marginal cost of replication that "work for you while you sleep."
- **Play long-term games with long-term people.** Compound interest applies to wealth, reputation, and relationships. All returns — financial, relational, intellectual — come from compounding over long horizons with the same trustworthy counterparties.
- **Escape competition through authenticity.** "No one can compete with you on being you." Specialize so narrowly into yourself that you exit the comparison set entirely.
...
- **Pick partners on intelligence, energy, and integrity — never compromise on any of the three.** "If you don't have integrity, the first two will kill you." (nav.al/rich)
- **Optimize for freedom and the long game over short-term optics.** "People living far below their means enjoy a freedom that people busy upgrading their lifestyles can't fathom."
...
- "A fit body, a calm mind, a house full of love. These things cannot be bought — they must be earned." (Almanack)
...
- **Assumes autonomy and safety nets many lack.** "Networks, passports, and savings shape 'permissionless' paths. The book underplays those frictions." Accountability is framed as pure upside, but "public mistakes compound too — and can be career-limiting for people without safety nets." Platform dependence is real: "algorithm or policy shifts can nuke reach." The framework "works brilliantly for autonomous creators in tech but assumes autonomy you may not have yet." (BetterSelfLabs)
